...
<div class="container">
    ...
    ?>
    <div class="col">
        <label for="inputNama_obat" class="form-label fw-bold">
            Nama Obat
        </label>
        <input type="varchar" class="form-control" name="nama_obat" id="inputNama_obat" placeholder="Nama_obat" value="<?php echo $nama_obat ?>">
    </div>
    <div class="col">
    ...
    <tr>
        ...
        <td><?php echo $data['harga'] ?></td>
                ...
                <td>
                    ...
                    href="obat.php?page=obat&id=<?php echo $data['id'] ?>&aksi=hapus">Hapus</a>
                    </a>
                </td>
            </tr>
        <?php
